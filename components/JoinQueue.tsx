  ...
  const handleJoinQueue = async () => {
    try {
      ...
      if (result.success) {
        ...
        toast({
          title: result.success ? "You are now in line!" : "Failed to join the waiting list",
          duration: 5000,
        });
      }
    } catch (error) {
  ...
  return (
    <div>
      {(!queuePosition ||
        ...
        <>
          {
          // You can not buy a ticket for your own event
          isEventOwner 
          ? (
          ...
          // You can not buy a ticket for a past event
          : isPastEvent ?
           (
          ...
          // You can not buy a ticket for a sold out event
